...
globalkeys = my_table.join(
    ...
    -- screenshot 
    --awful.key({ modkey, "Shift"   }, "s", function() awful.util.spawn( "xfce4-screenshooter -r" ) end),
    ...
    awful.key({ altkey,           }, "Tab",   function () awful.spawn(string.format("rofi -show window")) end,
        {description = "view next", group = "tag"}),
...
awful.spawn.with_shell("picom -b --config /dev/null ")
